...
exports.createTypeDefinitionSource = void 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default
                            .get(typedefsUrl, {
                            timeout: 60000,
                            timeoutErrorMessage: 'Timed out while trying to fetch the type definitions.',
                        })
                    ...
                    case 1:
                        ...
                        if (!Array.isArray(data)) {
                            throw new Error('The type definitions endpoint did not return the expected shape.');
                        }
